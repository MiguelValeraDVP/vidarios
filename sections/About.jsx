  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className="mt-[0.5rem] font-normal sm:text-[1.25rem] text-center text-secondary-white"
      >
      ...
      <motion.img
        ...
        src="/arrow-down.svg"
        alt="arrow down"
        className=" w-[18px] 5-[28px] object-contain mt-[28px]"
      />
    </motion.div>
  </section>
);
